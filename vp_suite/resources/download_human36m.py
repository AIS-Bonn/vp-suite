...
def get_cookie(username,password):
    ...
    cmd = f"wget --no-check-certificate --keep-session-cookies --save-cookies cookies.txt " \
          f"--post-data 'username={username}&password={password}' 'https://vision.imar.ro/human3.6m/checklogin.php'"
    ret = subprocess.call(cmd, shell=True)
